...
# ===============================================
# SWEEP FOR RUNNING THE DEFENSE AGAINST THE CORRELATED VALUE ENCODING ATTACK
# ===============================================
...
# Define the path to the defense config file
CVE_adult_sweep_config = os.path.join(Configuration.SWEEP_CONFIGS, 'CVE_defense_sweep_config.yaml')
