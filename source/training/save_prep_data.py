...
X_train_ex_l, y_train_ex_l, X_test_ex_l, y_test_ex_l, encoders_l = get_X_y_for_network(config=None, purpose='exfiltrate', exfiltration_encoding='label') #exfiltration_encoding=attack_config.exfiltration_encoding
